...
enum HTTP_CODE { NO_REQUEST, GET_REQUEST, BAD_REQUEST,
    FORBIDDEN_EWQUEST, INTERNAL_ERROR, CLOSED_CONNECTION};
...
int tmain()
{
    char s[] = "GET    http://www.baidu.com/index.html     HTTP/1.1";
    CHECK_STATE checkstate;
    parse_requestline(s, checkstate);
    return 0;
}
